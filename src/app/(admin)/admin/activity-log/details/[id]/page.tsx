...
export default function ActivityProfileDetailPage({
  activityId,
}: ActivityProfileDetailPageProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4">
        ...
        <div className="col-span-1 md:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <MetricCard
            ...
            value={patient.consultations}
          />
          <MetricCard
            title="Colheitas Realizadas"
            value={patient.collections}
          />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <ProfileCard
          ...
          icon={
            <UserSettingsIcon size={"24"} fill={ThemeColor.secondary[11]} />
          }
        ...
        <ProfileCard
          ...
          icon={
            <BloodPressureIcon size={"24"} fill={ThemeColor.secondary[11]} />
          }
