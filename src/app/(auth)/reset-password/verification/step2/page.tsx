      ...
      <div className="space-y-2">
        {method === "email" ? (
          <p className="text-md text-system-12">
            Enviamos um código de recuperação para o seu e-mail cadastrado. Por favor, verifique a sua caixa de entrada
            e a pasta de spam, se necessário.
          </p>
        ) : method === "sms" ? (
          <p className="text-md text-system-12">
            Enviamos um código de recuperação para o seu número cadastrado. Por favor, verifique a sua caixa de entrada
            e a pasta de spam, se necessário.
          </p>
        ) : (
          <p className="text-md text-system-12">
            Enviamos um código de recuperação. Por favor, verifique a sua caixa de entrada.
          </p>
        )}
      </div>
