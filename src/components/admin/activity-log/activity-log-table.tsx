...
export function ActivityLogTable({
  ...
  useEffect(() => {
    const fetchDatas = async () => {
      ...
      const mockData =
        mode === ActivityLogTab.Patients ? patients : businessUsers
  ...
  const columns: ColumnDef<User>[] = [
    {
      accessorKey: "id",
      header:
        mode === ActivityLogTab.Patients ? "ID DO PACIENTE" : "ID DO USUÁRIO",
