...
export function DeliverTable({
  ...
  useEffect(() => {
    const fetchDatas = async () => {
      ...
      const mockData =
        mode === DeliverTabOption.Order ? mockDelivers : mockDeliverHistory
  ...
  const deliverStatusFilterOptions: StatusOption<DeliverStatus>[] =
    DeliverStatusList.map((status) => ({
      value: status,
      label: status,
    }))
